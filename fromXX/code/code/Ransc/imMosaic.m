function [v0,m,vx,vy] = imMosaic( img1,img2)
...
[H corrPtIdx] = findHomography(matchLoc2',matchLoc1');
 ...
 m=eye(2)-H(1:2,1:2);
 v0=-H(1:2,3)';
 picCenter=floor((size(img1)+1)/2);
 [X,Y]=meshgrid(-picCenter(2)+1:size(img1,2)-picCenter(2),...
        size(img1,1)-picCenter(1):-1:-picCenter(1)+1);
