...
void CalcSqrDifferenceAndTakeBest(int dist, int height, short *mCurrFiltersImg, short *mCurrFiltersImgTarget,
...
//  addition for supporting the 'dist' part (parameters 'dist' and 'height' are for this)
	unsigned int rightCand, leftCand;
	  
    if (*pCurrBestMapping32u[0] == nCurrCandMapping32u)
        return;
	  
	rightCand = max((int)(nCurrCandMapping32u),(int)(nCurIterOffset32u));
	leftCand = min((int)(nCurrCandMapping32u),(int)(nCurIterOffset32u));

	for (k=0; k<dist; k++)
	{
			if (abs(rightCand-leftCand) < dist)
					  return;

			rightCand = rightCand - height;
	}    
//
    ...
    if (*pDownwardFlag) {
        ...
        for (j=nFirstColForward; j<nLastColForward; j++) {
            ...
            for (i=nFirstRowForward; i<nLastRowForward; i++) {
                ...
                CalcSqrDifferenceAndTakeBest(dist,mTarget,mCurrFiltersImg, mCurrFiltersImgTarget, &pCurrBestError32u,
                ...
                //// -- rotation invariant: repeat this (type 2) from the 4 directions --////
                // **************************** 1] right of left (original) **************
                ...
                CalcSqrDifferenceAndTakeBest(dist,mTarget,mCurrFiltersImg, mCurrFiltersImgTarget,
                ...
                // **************************** 2] left of left  ***************
                nCurrTypeMapping32u = nHorizNeighbourMapping32u - nLeftRightTargetOffset; // change is here
                nCurrTypeHashVal32u = pCodebookImgB32u[nCurrTypeMapping32u]-1;
                ...
                // **************************** 3] bottom of left  ***************
                nCurrTypeMapping32u = nHorizNeighbourMapping32u + nTopBotTargetOffset;  // change is here
                nCurrTypeHashVal32u = pCodebookImgB32u[nCurrTypeMapping32u]-1;
                ...
                // **************************** 2] top of top **************
                nCurrTypeMapping32u = nVerticalNeighbourMapping32u - nTopBotTargetOffset;  // change is here
                nCurrTypeHashVal32u = pCodebookImgB32u[nCurrTypeMapping32u]-1;
                ...
                // **************************** 3] right of top **************
                nCurrTypeMapping32u = nVerticalNeighbourMapping32u + nLeftRightTargetOffset;  // change is here
                nCurrTypeHashVal32u = pCodebookImgB32u[nCurrTypeMapping32u]-1;
