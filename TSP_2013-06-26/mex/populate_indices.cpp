...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
   ...
   for (int k=0; k<K; k++)
   {
      ...
      mxWriteField(plhs[0],k,"all", mxWriteVectorPtr(1,indices_all[k].getLength(),indices_all[k].getArray()));
      mxWriteField(plhs[0],k,"a",   mxWriteVectorPtr(1,indices_a[k].getLength(),indices_a[k].getArray()));
      mxWriteField(plhs[0],k,"c",   mxWriteVectorPtr(1,indices_c[k].getLength(),indices_c[k].getArray()));
      mxWriteField(plhs[0],k,"f",   mxWriteVectorPtr(1,indices_f[k].getLength(),indices_f[k].getArray()));
      mxWriteField(plhs[0],k,"b",   mxWriteVectorPtr(1,indices_b[k].getLength(),indices_b[k].getArray()));
      mxWriteField(plhs[0],k,"d",   mxWriteVectorPtr(1,indices_d[k].getLength(),indices_d[k].getArray()));
      mxWriteField(plhs[0],k,"u",   mxWriteVectorPtr(1,indices_u[k].getLength(),indices_u[k].getArray()));
   }
