...
public:
   ...
   static void JCSmoothFlowSOR(const DImage& Im1,const DImage& Im2, DImage& warpIm2, DImage& vx, DImage& vy,
                                           double alpha,int nOuterFPIterations,int nInnerFPIterations,int nSORIterations, const DImage &deriv_mask, const DImage &bad_mask);
   static void JCLaplacian(DImage& output,const DImage& input,const DImage& weight, const DImage &deriv_mask);
   static void JCCoarse2FineFlow(DImage& vx,DImage& vy,DImage &warpI2,const DImage& Im1,const DImage& Im2,double alpha,double ratio,int minWidth,
